...
const (
	...
	AdminComplianceDocumentPathZH = "legal/admin-compliance.zh.md"
	AdminComplianceDocumentPathEN = "legal/admin-compliance.en.md"
	AdminComplianceDocumentURLZH  = "/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 star-X 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the star-X Deployment and Operation Compliance Commitment"
