export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: '配置 Grok Build、Claude Code、Codex 或 OpenCode，让请求通过当前 star-X Grok 分组发送。',
        claudeDescription: '配置 Claude Code，让 Messages API 请求通过当前 star-X Grok 分组发送。',
        codexDescription: '配置 Codex，让 Responses API 请求通过当前 star-X Grok 分组发送。',
        ...
        codexNote: '将 config.toml 保存到 ~/.codex，并在启动 Codex 前设置 STAR_X_API_KEY。',
        codexNoteWindows: '将 config.toml 保存到 %USERPROFILE%\\.codex，并在 PowerShell 中设置 STAR_X_API_KEY 后启动 Codex。'
      },
      opencode: {
        title: 'OpenCode 配置示例',
  ...
  redeem: {
    ...
    currentBalance: '当前余额',
    buyCreditsTitle: '还没有兑换码？',
    buyCreditsDescription: '前往 Star-X 店铺购买额度，付款后复制店铺自动发放的兑换码并在下方兑换。',
    buyCreditsButton: '购买额度',
    redirectingToStore: '正在前往 Star-X 额度商店…',
    concurrency: '并发数',
    requests: '请求',
    redeemCodeLabel: '兑换码',
