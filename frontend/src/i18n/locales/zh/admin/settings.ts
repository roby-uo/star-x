export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 star-X 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 star-X 用户登录',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期获取 OpenAI API Key 所连接上游 star-X 站点声明的计费倍率。',
        enabled: '启用全局自动探测',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 star-X 订单中，上游 type 会作为易支付 type 参数提交。',
      ...
      openaiFastPolicy: {
        ...
        scopeBedrock: '仅 Bedrock 账号',
        userIds: '指定用户',
        userIdsHint: '输入任意邮箱关键词进行模糊搜索。留空表示对全部 star-X 用户生效；选中用户的 API Key 请求优先匹配用户规则。',
