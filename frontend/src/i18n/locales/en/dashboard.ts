export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        quickSetupTitle: 'Recommended: Configure Codex in one step',
        quickSetupDescription: 'No hidden-file hunting required. Run the command below to create the directory, back up existing files, and install the Star-X configuration.',
        quickSetupStepOneWindows: 'Copy the setup command, then open PowerShell from the Start menu.',
        quickSetupStepOneUnix: 'Copy the setup command, then open Terminal.',
        quickSetupStepTwo: 'Paste the complete command, press Enter, and wait for the completion message.',
        quickSetupStepThree: 'Completely quit and reopen Codex, then create a new task.',
        copyInstallCommand: 'Copy setup command',
        quickSetupBackupNotice: 'The command replaces the current Codex files after creating timestamped .starx-backup copies in the same directory. It contains your API key; do not share it.',
        manualSetupTitle: 'Manual setup (advanced)',
        manualSetupStepsTitle: 'Cannot find the configuration files?',
        manualSetupPathWindows: 'Press Win + R, enter %USERPROFILE%\\.codex, and press Enter. Create the .codex folder first if it does not exist.',
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your star-X Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your star-X Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your star-X Grok group.',
        ...
        codexNote: 'Save config.toml under ~/.codex and set STAR_X_API_KEY before starting Codex.',
        codexNoteWindows: 'Save config.toml under %USERPROFILE%\\.codex and set STAR_X_API_KEY in PowerShell before starting Codex.',
      },
      opencode: {
      ...
      hermes: {
        description: 'Configure the Hermes custom provider to use the star-X OpenAI-compatible endpoint.',
      ...
      'trae-ide': {
        ...
        path: 'Settings → Models → Add model → Custom configuration',
        ...
        enabled: 'Enabled',
        hint: 'Enable Full URL in TraeCode, then enter the values below.',
        note: 'TraeCode validates the connection on save. If it fails, confirm the selected group supports Chat Completions for this model.',
      },
    },
  ...
  redeem: {
    ...
    buyCreditsTitle: 'Need a redeem code?',
    buyCreditsDescription: 'Buy credits from the Star-X store, then copy the automatically delivered code and redeem it below.',
    buyCreditsButton: 'Buy Credits',
    redirectingToStore: 'Redirecting to the Star-X credit store…',
