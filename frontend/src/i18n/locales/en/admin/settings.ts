export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for star-X end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for star-X end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream star-X sites connected to OpenAI API keys.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'star-X',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
		siteSubtitlePlaceholder: 'Your private AI API gateway',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on star-X orders; the upstream type is sent as EasyPay type.',
      ...
      openaiFastPolicy: {
        ...
        userIdsHint: 'Type any part of a user email to search. Leave empty to apply to all star-X users. Selected users match requests from their API keys and take precedence over global rules.',
