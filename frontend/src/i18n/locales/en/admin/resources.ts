export default {
    ...
    redeem: {
      ...
      copied: 'Copied!',
      download: 'Download',
      downloadStoreCards: 'Download Store Cards (TXT)',
      storeCardReady: 'Store card file is ready',
      storeCardHint: 'The file contains one redeem code per line. Import it into the matching product inventory so buyers receive a code automatically after payment.',
