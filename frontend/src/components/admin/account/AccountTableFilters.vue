<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.endpoint" class="w-40" :options="endpointOpts" @update:model-value="updateEndpoint" @change="$emit('change')" />
...
const updateEndpoint = (value: string | number | boolean | null) => { emit('update:filters', { ...props.filters, endpoint: value }) }
...
const endpointOpts = computed(() => [{ value: '', label: t('admin.accounts.allEndpoints') }, { value: 'chat', label: 'Chat' }, { value: 'responses', label: 'Responses' }, { value: 'images', label: 'Images' }])
