    ...
    <main id="top">
      <section class="hero section-shell">
        <div class="hero-copy">
          ...
          <div class="hero-logo-wrap"><img src="/starx-logo-transparent.png" alt="star-X" class="hero-logo" /></div>
...
@media (max-width:900px){.nav-links{display:none}.hero{grid-template-columns:1fr;gap:45px;padding-top:54px}.hero-copy{text-align:center}.trust-list{justify-content:center}.api-panel{max-width:650px;margin:auto}.feature-grid{grid-template-columns:1fr}.metrics{grid-template-columns:1fr 1fr;gap:22px}.metric:nth-child(2){border-right:0}.capability-board{grid-template-columns:1fr}.capability,.capability:nth-child(odd){border-right:0;border-top:1px solid var(--line)}.capability:first-child{border-top:0}.benefit-row{grid-template-columns:1fr 1fr;gap:18px}.steps{gap:35px}.cta{flex-direction:column;padding:31px 24px}.site-footer{flex-wrap:wrap}.site-footer small{margin-left:0;width:100%}}
