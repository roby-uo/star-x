<template>
  ...
  <div v-else class="star-home" :class="{ 'star-home--dark': isDark }">
...
function startTerminalTyping() {
  ...
  const typeNext = () => {
    ...
    if (index < terminalResponseText.length) {
      index += 1
      terminalTypingTimer = window.setTimeout(typeNext, index === 1 ? 480 : 250)
      return
    }
...
:global(.dark) .star-home,.star-home--dark { --ink:#edf3ff; --muted:#aebbd2; --line:rgba(133,158,210,.09); background:radial-gradient(circle at 70% 16%,rgba(67,105,209,.4),transparent 31%),linear-gradient(130deg,#080e1d,#10182d 48%,#182447); }:global(.dark) .star-hero h1,.star-home--dark .star-hero h1,:global(.dark) .star-hero__subtitle,.star-home--dark .star-hero__subtitle,:global(.dark) .star-feature-card h2,.star-home--dark .star-feature-card h2,:global(.dark) .star-providers h2,.star-home--dark .star-providers h2{color:#f5f8ff}:global(.dark) .star-feature-card,.star-home--dark .star-feature-card,:global(.dark) .star-provider,.star-home--dark .star-provider{background:rgba(18,29,55,.69);border-color:rgba(153,178,237,.18)}:global(.dark) .star-tags,.star-home--dark .star-tags,:global(.dark) .star-providers>p,.star-home--dark .star-providers>p{color:#bfc9dc}
